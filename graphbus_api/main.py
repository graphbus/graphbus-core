    ...
    return {
        ...
        "endpoints": {
            ...
            "negotiations": {
                ...
                "register_party":  "POST   /api/negotiations/{session_id}/parties",
                "list_parties":    "GET    /api/negotiations/{session_id}/parties",
                "remove_party":    "DELETE /api/negotiations/{session_id}/parties/{party_id}",
                "post_message":    "POST   /api/negotiations/{session_id}/messages",
                "list_messages":   "GET    /api/negotiations/{session_id}/messages?since=N",
                "bind_slack":      "POST   /api/negotiations/{session_id}/slack",
            },
        },
    }
